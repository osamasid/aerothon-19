...
var TableListComponent = /** @class */ (function () {
    ...
    TableListComponent.prototype.getInitializeFlights = function () {
        var _this = this;
        this.dataService.getCustomer("5c7d4736687cbd72e6a25b8b")
            .subscribe(function (response) {
            _this.customers = response;
        }, function (err) { return console.log(err); }, function () { return console.log('getCustomer("5c7d4736687cbd72e6a25b8b") retrieved customers'); });
    };
